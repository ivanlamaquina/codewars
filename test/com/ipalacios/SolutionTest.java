...
public class SolutionTest {
    ...
    private static Map<String, String[][]> VALID_CAPTURE_DATAS = new HashMap<String,String[][]>() {{
        ...
        put("Black captures single white stone",
                new String[][] {{"4D","3D","4H","5D","3H","4C","5B","4E"},
                        {"4D"}});

        put("Black captures multiple white stones",
                new String[][] {{"6D","7E","6E","6F","4D","5E","5D","7D",
        ...
        put("Corner capture",
                new String[][] {{"9A","8A","8B","9B"},
                        {"9A"}});

        put("Multiple captures",
                new String[][] {{"5D","5E","4E","6E","7D","4F","7E","3E","5F","4D",
                        "6F","6D","6C","7F","4E","5E"},
                        {"4E","6D","6E"}});

        put("Snapback",
                new String[][] {{"5A","1E","5B","2D","5C","2C","3A",
    ...
    public void test_getSize() {
        ...
        assertEquals("Should be able to get the size of the correct board",
                new HashMap<String,Integer>() {{ put("height", h);  put("width", w); }}, g.getSize());
    }
    ...
    public void test_getColorTurn() {
        Go g = new Go(9);
        g.move("3B");
        assertEquals("Should be able to get the color of the current turn",
                "white", g.getTurn());
        g.move("4B");
        assertEquals("Should be able to get the color of the current turn",
                "black", g.getTurn());
